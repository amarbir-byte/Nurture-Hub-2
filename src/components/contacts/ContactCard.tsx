      ...
      <div className="pt-6 border-t border-primary-100 dark:border-primary-800">
        <div className="flex justify-center space-x-2">
          ...
          <button
            ...
            className="btn-ghost btn-sm text-error-600 dark:text-error-400 hover:text-error-700 dark:hover:text-error-300 hover:bg-error-50 dark:hover:bg-error-900/20"
          >
